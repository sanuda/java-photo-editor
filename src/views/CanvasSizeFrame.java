 ...
 */
public class CanvasSizeFrame extends javax.swing.JFrame {

    JPanel canvas;
    MainFrame frame;

    /**
     * Creates new form CanvasSizeFrame
     */
    public CanvasSizeFrame(JPanel canvas, MainFrame frame) {
        initComponents();
        this.canvas=canvas;
        this.frame=frame;
        jSpinnerWidth.setValue(frame.canvasWidth);
        jSpinnerHeight.setValue(frame.canvasHeight);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanvasSizeFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new CanvasSizeFrame().setVisible(true);
            }
        });
    }
